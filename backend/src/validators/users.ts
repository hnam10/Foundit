...
export const updateProfileSchema = z
  ...
  .refine((data) => data.firstName !== undefined || data.lastName !== undefined || data.phone !== undefined, {
...
export const createUserSchema = z.object({
  ...
  studentNumber: z.coerce.number().int().min(100000000).max(999999999).optional(),
